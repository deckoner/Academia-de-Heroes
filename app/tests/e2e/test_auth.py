...
class TestLoginE2E:
    ...
    def test_login_with_valid_credentials(self):
        ...
        Usuario.objects.create(user=user, DNI="12345678A", email="test@test.com")
    ...
    def test_login_with_invalid_password(self):
        ...
        user = User.objects.create_user(username="testuser", password="testpass123")
        Usuario.objects.create(user=user, DNI="12345678B", email="test@test.com")
    ...
    def test_login_redirects_to_home(self):
        ...
        user = User.objects.create_user(username="testuser", password="testpass123")
        Usuario.objects.create(user=user, DNI="12345678C", email="test@test.com")

        client = Client()
        response = client.post(
            "/login/", {"username": "testuser", "password": "testpass123"}, follow=True
        )
        assert response.status_code == 200
...
class TestAuthFlowE2E:
    ...
    def test_complete_auth_flow(self):
        ...
        # Login
        response = client.post(
            "/login/", {"username": "flowuser", "password": "password123"}
        )
        assert response.status_code == 302
