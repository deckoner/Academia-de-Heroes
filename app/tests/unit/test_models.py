...
class TestPersonajeModel(TestCase):
    ...
    def test_crear_personaje_base(self):
        ...
        p = Personaje.objects.create(
            tipo="PERSONAJE", nombre="Heroe1", nivel=1, vida=100, vida_max=100
        )
    ...
    def test_crear_mago(self):
        ...
        p = Personaje.objects.create(
            tipo="MAGO", nombre="Mago1", nivel=1, vida=80, vida_max=80, mana=50
        )
    ...
    def test_esta_vivo(self):
        ...
        p = Personaje.objects.create(
            tipo="PERSONAJE", nombre="TestVivo", nivel=1, vida=50, vida_max=100
        )
        self.assertTrue(p.esta_vivo())
    ...
    def test_recibir_danio(self):
        ...
        p = Personaje.objects.create(
            tipo="PERSONAJE", nombre="TestDanio", nivel=1, vida=100, vida_max=100
        )
        p.recibir_danio(30)
    ...
    def test_recibir_danio_negativo_lanza_error(self):
        ...
        p = Personaje.objects.create(
            tipo="PERSONAJE", nombre="TestDanioNeg", nivel=1, vida=100, vida_max=100
        )
    ...
    def test_curar(self):
        ...
        p = Personaje.objects.create(
            tipo="PERSONAJE", nombre="TestCurar", nivel=1, vida=30, vida_max=100
        )
        p.curar(50)
    ...
    def test_curar_no_supera_maximo(self):
        ...
        p = Personaje.objects.create(
            tipo="PERSONAJE", nombre="TestCurarMax", nivel=1, vida=90, vida_max=100
        )
        p.curar(50)
    ...
    def test_subir_nivel(self):
        ...
        p = Personaje.objects.create(
            tipo="PERSONAJE", nombre="TestSubir", nivel=1, vida=100, vida_max=100
        )
        p.subir_nivel()
    ...
    def test_ataque(self):
        ...
        p = Personaje.objects.create(
            tipo="PERSONAJE", nombre="TestAtaque", nivel=5, vida=100, vida_max=100
        )
    ...
    def test_unique_nombre(self):
        ...
        Personaje.objects.create(
            tipo="PERSONAJE", nombre="Unico", nivel=1, vida=100, vida_max=100
        )
...
class TestMago(TestCase):
    ...
    def test_ataque_especial_con_mana(self):
        ...
        p = Personaje.objects.create(
            tipo="MAGO", nombre="MagoAtaque", nivel=5, vida=100, vida_max=100, mana=50
        )
    ...
    def test_ataque_especial_sin_mana(self):
        ...
        p = Personaje.objects.create(
            tipo="MAGO", nombre="MagoSinMana", nivel=5, vida=100, vida_max=100, mana=5
        )
        dano = p.ataque_especial()
